	...
	\section{Resumen de tiempo invertido y puntuaciones}
		...
		\subsection*{Iteración 4}			
			\begin{tabular}{|c|c|c|}
				...
				Nombre & Total de tiempo & Puntuación\\
				\hline
				Samuel Navas Portillo & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				Juan Jesús Pérez Luna & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				Manuel de los Santos Campos & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				María José Sancha Maya & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				Ángel Martínez Olivares & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				José Antonio Jiménez Carmona & \textbf{\color{red} ToDo} & \textbf{\color{red} ToDo}\\
				\hline
			\end{tabular}
