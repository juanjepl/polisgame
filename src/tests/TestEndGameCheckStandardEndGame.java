...
import game.EndGameCheckStandardEndGame;
import game.Game;
...
public class TestEndGameCheckStandardEndGame {
	Game polisGame;
	...
	public void TestEndGameManagerCreation() {
		EndGameCheckStandardEndGame m = new EndGameCheckStandardEndGame(
				polisGame, sparta);
	...
	public void TestNullGame() {
		EndGameCheckStandardEndGame m = new EndGameCheckStandardEndGame(null,
				sparta);
		assert (m.getGame().equals(polisGame));
		assert (m.getPlayer().equals(sparta));
	...
	@Test
	public void TestWinnerSpartaForPrestige() {
		athens.setPrestige(2);
		sparta.setPrestige(23);
		EndGameCheckStandardEndGame m = new EndGameCheckStandardEndGame(
				polisGame, sparta);
