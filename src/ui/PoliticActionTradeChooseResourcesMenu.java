...
public class PoliticActionTradeChooseResourcesMenu extends AbstractMenu{
	
	private Market market;
	private List<String> availableValuesForRequest;
	
	public PoliticActionTradeChooseResourcesMenu(Map<String, String> gameTexts, List<IMenu> menuList,Game game, Market market)
	{
	...
	public String getHeaderMessage() {
		return getGameTexts().get("politicActionTradeChooseResourcesMenu_headerMessage");
	}
	...
	public IMenu getNextMenu() {
		...
		default:
			...
			next = new PoliticActionTradeChooseResourceNeededMenu(getGameTexts(), getMenuList(), getGame(), market, resource2);
			break;
		}
		return next;
	}
