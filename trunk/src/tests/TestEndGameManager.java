...
public class TestEndGameManager {
	@Mock
	Player mockSparta;
	@Mock
	Player mockAthens;
	...
	@Test
	public void TestEndGameManagerCreation() {
		 EndGameManager m = new EndGameManager(polisGame,sparta);
	...
	public void TestNullGame() {
		 EndGameManager m = new EndGameManager(null, sparta);
		assert (m.getGame().equals(mockGame));
		assert (m.getPlayer().equals(mockSparta));

	}
	@Test(expected = IllegalArgumentException.class)
	public void TestNullPlayer() {
		 EndGameManager m = new EndGameManager(polisGame, null);
		assert (m.getGame().equals(mockGame));
		assert (m.getPlayer().equals(mockSparta));

	}
	@Test
	public void TestEndGameManagerGetters() {
		 EndGameManager m = new EndGameManager(polisGame,sparta);
		assert (m.getGame().equals(polisGame));
		assert (m.getPlayer().equals(sparta));
