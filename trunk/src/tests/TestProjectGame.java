...
public class TestProjectGame {
	...
	public void testPhilosoPherCreation() {
		ProjectGame p = new ProjectGame(mockSysName, mockName, mockPrestige,
	...
	public void testNullSysName() {
		ProjectGame p = new ProjectGame(null, mockName, mockPrestige,
				mockPrestigeToPosterity, mockResourcesRequired);
		assert (p.getSysName().equals(mockSysName));
		assert (p.getName().equals(mockName));
		assert (p.getPrestige() == (mockPrestige));
	...
	public void testNullName() {
		ProjectGame p = new ProjectGame(mockSysName, null, mockPrestige,
				mockPrestigeToPosterity, mockResourcesRequired);
	...
	public void testNullPrestige() {
		ProjectGame p = new ProjectGame(mockSysName, mockName, null,
				mockPrestigeToPosterity, mockResourcesRequired);
