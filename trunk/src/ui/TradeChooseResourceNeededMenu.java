...
public class TradeChooseResourceNeededMenu extends AbstractMenu{

	private Market market;
	private String resource2;
	private List<String> availableValuesForRequest;
	
	public TradeChooseResourceNeededMenu(Map<String, String> gameTexts, List<IMenu> menuList,Game game, Market market, String resource2)
	{
	...
	public void showActionDoneMessage(String resource1){
		...
		System.out.println(getGameTexts().get(resource1)+ " " + getGameTexts().get("tradeChooseResourceNeededMenu_tradedBy") + " " + getResource2());//FIXME
	}
